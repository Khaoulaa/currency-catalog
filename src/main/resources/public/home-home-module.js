...
/* harmony import */ var ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-bootstrap/utils */ "./node_modules/ngx-bootstrap/utils/fesm5/ngx-bootstrap-utils.js");
...
var BsDropdownContainerComponent = /** @class */ (function () {
    function BsDropdownContainerComponent(_state, cd, _renderer, _element) {
        ...
        function (value) {
            ...
            if (dropdown && !Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_4__["isBs3"])()) {
...
var BsDropdownDirective = /** @class */ (function () {
     ...
     */
    function () {
        if (!Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_4__["isBs3"])()) {
            this.addShowClass();
    ...
    BsDropdownDirective.propDecorators = {
        ...
        triggers: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
        ...
        autoClose: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
        insideClick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
...
var BsDropdownToggleDirective = /** @class */ (function () {
    ...
    BsDropdownToggleDirective.propDecorators = {
        isDisabled: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"], args: ['attr.disabled',] }],
        isOpen: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"], args: ['attr.aria-expanded',] }],
...
var routes = [
    { path: '', component: _home_component__WEBPACK_IMPORTED_MODULE_3__["HomeComponent"], data: { title: "Home" } }
];
...
module.exports = "<div class=\"container-body\">\n    <h2> Currencies availables</h2>\n    <div class =\"nav-items ui-g\">\n        <div class=\"\" class=\"section-search\">\n            <input placeholder=\"search\" [(ngModel)]=\"fieldSearch\"><i *ngIf=\"fieldSearch.length === 0\" class=\"fa fa-search\" aria-hidden=\"true\"></i>\n        </div>\n        <div class=\"\" class=\"section-dropdown\">\n                <div class=\"btn-group\" dropdown>\n                        <button id=\"button-basic\" dropdownToggle type=\"button\" class=\"btn btn-primary dropdown-toggle\"\n                                aria-controls=\"dropdown-basic\">\n                          {{fieldName === null ? 'By field' : fieldName }} <span class=\"caret\"></span>\n                        </button>\n                        <ul id=\"dropdown-basic\" *dropdownMenu class=\"dropdown-menu\"\n                            role=\"menu\" aria-labelledby=\"button-basic\">\n                          <li role=\"menuitem\" *ngFor=\"let item of items;let i=index\" (click) = \"filterbyField(i)\">\n                              <a class=\"dropdown-item\" >{{item}}</a>\n            \n                           </li>\n                         \n                        </ul>\n                      </div>  \n        </div>\n    </div>\n\n\n<div class=\"ui-g content-items\" >\n    <div class=\"alert-empty\" *ngIf=\"isEmpty\">No Currencies !</div>\n    <div class=\"ui-sm-6 ui-md-3 ui-lg-2  item\" *ngFor=\"let currency of currencies\">\n         <div class=\"section-des\">\n           <span> <b>Id : </b> <span class=\"link\" (click)=\"goToDetailsCurrency(currency)\"> {{currency.id}} </span></span>\n           <span><b>Type: </b> {{currency.attributes.currency_type }} </span>\n           <span><b>Symbol:</b> {{currency.attributes.symbol}}</span>\n        </div>  \n    </div>\n</div>\n<div class=\"ui-g\">\n <p-paginator *ngIf=\"isLoaded\" [rows]=\"6\" [totalRecords]=\"totalRecords\" (onPageChange)=\"paginate($event)\"  [rowsPerPageOptions]=\"[6,12,24]\"></p-paginator>\n</div>\n</div>"
...
module.exports = ".container-body {\n  padding: 5%;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  width: 100%; }\n  .container-body .nav-items {\n    flex-direction: row;\n    justify-content: space-between;\n    align-items: center;\n    flex-wrap: nowrap; }\n  .container-body .nav-items .section-search {\n      position: relative; }\n  .container-body .nav-items .section-search ::-webkit-input-placeholder {\n        padding-left: 20px;\n        font-size: 12px; }\n  .container-body .nav-items .section-search i {\n        position: absolute;\n        top: 7px;\n        left: 6px;\n        color: #707a88;\n        font-size: 13px; }\n  .container-body .nav-items .section-search input {\n        width: 70%;\n        font-size: 13px; }\n  .container-body .content-items {\n    padding-top: 30px;\n    padding-bottom: 30px;\n    width: 100%; }\n  .container-body .content-items .alert-empty {\n      width: 100%;\n      padding: 10px;\n      border: 1px solid #dca7089c;\n      font-size: 13px;\n      background-color: #fdd5748a;\n      color: #986f05; }\n  .container-body .content-items .item .section-des {\n      border: 1px solid #ccc;\n      padding: 5px; }\n  .container-body .content-items .item .section-des span {\n        font-size: 14px;\n        display: inline-block;\n        margin-right: 5px; }\n  .container-body .content-items .item .section-des .link {\n        color: #1d8596; }\n  .container-body .content-items .item .section-des .link:hover {\n          cursor: pointer;\n          color: #106573;\n          font-weight: 500; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_currencyService, _router) {
        this._currencyService = _currencyService;
        this._router = _router;
        this.maxSize = 6;
        this.currentPage = 0;
        this.isLoaded = false;
        this.items = ['id', 'code', 'name', 'type'];
        this.fieldSearch = "";
        this.fieldName = null;
        this.isEmpty = false;
    }
    ...
    HomeComponent.prototype.initDataCurrencies = function () {
        var _this = this;
        this._currencyService.getAllCurrencies(this.maxSize, this.fieldName, this.fieldSearch).subscribe(function (data) {
            _this.totalRecords = Object.keys(data).length * _this.maxSize;
            _this.currencies = data[_this.currentPage + ""];
            _this.isEmpty = Object.keys(data).length === 0 ? true : false;
            _this.isLoaded = true;
        });
    };
    ...
    HomeComponent.prototype.filterbyField = function (index) {
        this.fieldName = this.items[index];
        this.initDataCurrencies();
    };
    HomeComponent.prototype.goToDetailsCurrency = function (currency) {
    ...
    HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_currency_service__WEBPACK_IMPORTED_MODULE_2__["CurrencyService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], HomeComponent);
